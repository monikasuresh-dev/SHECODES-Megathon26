...
# Physical distress, dizziness, and medical vulnerability patterns
PHYSICAL_DISTRESS_PATTERNS: List[Tuple[str, int, str]] = [
    ("feeling a bit of dizzy", 65, "physical_distress"),
    ("feeling a bit dizzy", 65, "physical_distress"),
    ("a bit of dizzy", 65, "physical_distress"),
    ("a bit dizzy", 65, "physical_distress"),
    ("feeling dizzy", 65, "physical_distress"),
    ("feel dizzy", 65, "physical_distress"),
    ("i am dizzy", 65, "physical_distress"),
    ("im dizzy", 65, "physical_distress"),
    ("so dizzy", 65, "physical_distress"),
    ("dizzy", 65, "physical_distress"),
    ("dizziness", 65, "physical_distress"),
    ("not feeling well", 65, "physical_distress"),
    ("not feeling very well", 65, "physical_distress"),
    ("dont feel well", 65, "physical_distress"),
    ("don t feel well", 65, "physical_distress"),
    ("not feeling good", 60, "physical_distress"),
    ("feeling sick", 65, "physical_distress"),
    ("feel sick", 65, "physical_distress"),
    ("feeling faint", 65, "physical_distress"),
    ("feel faint", 65, "physical_distress"),
    ("head is spinning", 65, "physical_distress"),
    ("room is spinning", 65, "physical_distress"),
    ("i fell down", 70, "physical_distress"),
    ("fell down", 70, "physical_distress"),
    ("i fell", 70, "physical_distress"),
    ("having chest pain", 70, "physical_distress"),
    ("cannot breathe", 70, "physical_distress"),
]
