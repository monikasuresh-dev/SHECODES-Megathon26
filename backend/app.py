...
def detect_and_update_name(raw_text: str, payload_data: Dict[str, Any]) -> None:
    ...
    # Explicit introduction: "my name is Aadil", "name is Aadil", "call me Aadil"
    ...
    if not name_match:
        # Secondary: "I am Aadil", "I'm Aadil" - must NOT be an adjective/participle
...
if __name__ == "__main__":
    ...
    print(f"Starting SHECODES Dementia Companion Backend on http://localhost:{port}")
